...
<body>
	<h1>Enter the details of your submission here</h1>
	<h2>The fields marked with * are required</h2>
	<sf:form method="POST" modelAttribute="submission">
		<fieldset>
			<table>
				<tr>
				...
				<tr>
					<th><label for="submission_description">*Description of dish including how to make it</label></th>
					<td><sf:textarea path="description" /></td>
					<td><sf:errors path="description" cssStyle="color: #ff0000;"></sf:errors></td>
				</tr>
				<tr>
					<th><label for="submission_pictures">*Pictures URL of your dish</label></th>
					<td><sf:input path="pictures" /></td>
					<td><sf:errors path="pictures" cssStyle="color: #ff0000;"></sf:errors></td>
				</tr>
				<tr>
					<th><label for="submission_videourl">*Video URL of you creating your dish</label></th>
					<td><sf:input path="videourl" /></td>
					<td><sf:errors path="videourl" cssStyle="color: #ff0000;"></sf:errors></td>
				</tr>
				<tr>
					<th><label for="submission_tag">*Tags of your dish?</label></th>
					<td><sf:textarea type="textarea" path="tag" /></td>
					<td><sf:errors path="tag" cssStyle="color: #ff0000;"></sf:errors></td>
				</tr>
				<tr>
					<th><label for="submission_ingredientlist">*What ingredients did you use to make your dish?</label></th>
				...
				<tr>
					...
					<!-- This hidden field is required for Hibernate to recognize this submission -->
